# Rspscale CLI and daemon dependencies

The following open source dependencies are used to build the [rspscale][] and
[rspscaled][] commands. These are primarily used on Linux and BSD variants as
well as an [option for macOS][].

[rspscale]: https://pkg.go.dev/scale.ropsoft.cloud/cmd/rspscale
[rspscaled]: https://pkg.go.dev/scale.ropsoft.cloud/cmd/rspscaled
[option for macOS]: https://scale.ropsoft.cloud/kb/1065/macos-variants/
...
Some packages may only be included on certain architectures or operating systems.
 ...
 - [scale.ropsoft.cloud](https://pkg.go.dev/scale.ropsoft.cloud) ([BSD-3-Clause](https://github.com/ropsoft7/rspscale/blob/HEAD/LICENSE))
 - [scale.ropsoft.cloud/tempfork/gliderlabs/ssh](https://pkg.go.dev/scale.ropsoft.cloud/tempfork/gliderlabs/ssh) ([BSD-3-Clause](https://github.com/ropsoft7/rspscale/blob/HEAD/tempfork/gliderlabs/ssh/LICENSE))
 - [scale.ropsoft.cloud/tempfork/spf13/cobra](https://pkg.go.dev/scale.ropsoft.cloud/tempfork/spf13/cobra) ([Apache-2.0](https://github.com/ropsoft7/rspscale/blob/HEAD/tempfork/spf13/cobra/LICENSE.txt))
