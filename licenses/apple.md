# Rspscale for macOS/iOS/tvOS dependencies

The following open source dependencies are used to build Rspscale on [macOS][], [iOS][] and [tvOS][].
See also the dependencies in the [Rspscale CLI][].

[macOS]: https://scale.ropsoft.cloud/kb/1016/install-mac/
[iOS]: https://scale.ropsoft.cloud/kb/1020/install-ios/
[tvOS]: https://scale.ropsoft.cloud/kb/1280/appletv/
[Rspscale CLI]: ./rspscale.md
