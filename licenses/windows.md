# Rspscale for Windows dependencies

The following open source dependencies are used to build [Rspscale on
Windows][].  See also the dependencies in the [Rspscale CLI][].

[Rspscale on Windows]: https://scale.ropsoft.cloud/kb/1022/install-windows/
