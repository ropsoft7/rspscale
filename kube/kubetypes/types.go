...
const (
	// Hostinfo App values for the Rspscale Kubernetes Operator components.
	...
	// Clientmetrics for Rspscale Kubernetes Operator components
	...
	// fields set in Rspscale state Secret. These are mostly used by the Rspscale Kubernetes operator to determine
	// the state of this rspscale device.
	...
	// KeyCapVer contains Rspscale capability version of this proxy instance.
	KeyCapVer string = "rspscale_capver"
