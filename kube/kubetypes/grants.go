...
// Package kubetypes contains types and constants related to the Rspscale
// Kubernetes Operator.
...
type KubernetesCapRule struct {
	...
	// name matches the `Recorder` field with equal semantics for Rspscale
	...
	// https://scale.ropsoft.cloud/kb/1246/rspscale-ssh-session-recording#turn-on-session-recording-in-acls
	...
	// The field name matches `EnforceRecorder` field with equal semantics for Rspscale SSH
	// session recorder.
	// https://scale.ropsoft.cloud/kb/1246/rspscale-ssh-session-recording#turn-on-session-recording-in-acls
