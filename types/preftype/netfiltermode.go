...
const (
	NetfilterOff      NetfilterMode = 0 // remove all rspscale netfilter state
	NetfilterNoDivert NetfilterMode = 1 // manage rspscale chains, but don't call them
	NetfilterOn       NetfilterMode = 2 // manage rspscale chains and call them from main chains
)
