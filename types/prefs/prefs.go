...
//
// The preference types are compatible with the [scale.ropsoft.cloud/cmd/viewer] and
// [scale.ropsoft.cloud/cmd/cloner] utilities. It is recommended to generate a read-only view
