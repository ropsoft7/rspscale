...
func ExamplePrefs_AdvertiseRoutes_setValue() {
	...
	// [scale.ropsoft.cloud/cmd/viewer] can be used instead of the mutable Prefs struct.
...
func ExamplePrefs_ControlURL_setDefaultValue() {
	...
	// Output:
	// Default: https://controlplane.scale.ropsoft.cloud
	// User Set: https://control.example.com
	// Reset to Default: https://controlplane.scale.ropsoft.cloud
}
