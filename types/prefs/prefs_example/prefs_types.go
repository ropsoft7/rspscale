...
// Package prefs_example contains a [Prefs] type, which is like [scale.ropsoft.cloud/ipn.Prefs],
...
// and due to limitations in [scale.ropsoft.cloud/cmd/viewer] when
...
import (
	...
	"scale.ropsoft.cloud/types/prefs"
	"scale.ropsoft.cloud/types/preftype"
)

//go:generate go run scale.ropsoft.cloud/cmd/viewer --type=Prefs,AutoUpdatePrefs,AppConnectorPrefs

// Prefs is like [scale.ropsoft.cloud/ipn.Prefs], but with individual preferences wrapped in
...
//
// Just like [scale.ropsoft.cloud/ipn.Prefs], [Prefs] is a mutable struct. It should
