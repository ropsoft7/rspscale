...
// rspscale instance. The web interface is not used by default,
...
type webClient struct {
	...
	// to the localapi for this rspscaled instance.
...
// for each of the local device's Rspscale IP addresses. This is needed to properly
...
// used to manage this Rspscale instance.
...
// rspscaled instance via the web client.
