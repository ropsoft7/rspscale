	...
	tests := []struct {
	...
	}{
		{
			...
			wantHeaders: []headerCheck{
				...
				{"Rspscale-User-Login", "someone@example.com"},
				{"Rspscale-User-Name", "Some One"},
				{"Rspscale-User-Profile-Pic", "https://example.com/photo.jpg"},
				{"Rspscale-Headers-Info", "https://scale.ropsoft.cloud/s/serve-headers"},
			},
		},
		{
			...
			wantHeaders: []headerCheck{
				...
				{"Rspscale-User-Login", ""},
				{"Rspscale-User-Name", ""},
				{"Rspscale-User-Profile-Pic", ""},
				{"Rspscale-Headers-Info", ""},
			},
		},
		{
...
func TestEncRspscaleHeaderValue(t *testing.T) {
	tests := []struct {
		in   string
		want string
	}{
	...
	for _, tt := range tests {
		got := encRspscaleHeaderValue(tt.in)
		if got != tt.want {
			t.Errorf("encRspscaleHeaderValue(%q) = %q, want %q", tt.in, got, tt.want)
		}
	}
}
