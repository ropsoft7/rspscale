...
func TestStdHandler_Panic(t *testing.T) {
	...
	if s := "\nscale.ropsoft.cloud/tsweb.panicElsewhere("; !strings.Contains(r.Err, s) {
...
func TestCleanRedirectURL(t *testing.T) {
	rspscaleHost := []string{"scale.ropsoft.cloud"}
	rspscaleAndOtherHost := []string{"microsoft.com", "scale.ropsoft.cloud"}
	...
	cases := []struct {
		...
		{"http://scale.ropsoft.cloud/foo", rspscaleHost, "http://scale.ropsoft.cloud/foo", false},
		{"http://scale.ropsoft.cloud/foo", rspscaleAndOtherHost, "http://scale.ropsoft.cloud/foo", false},
		{"http://microsoft.com/foo", rspscaleAndOtherHost, "http://microsoft.com/foo", false},
		{"https://scale.ropsoft.cloud/foo", rspscaleHost, "https://scale.ropsoft.cloud/foo", false},
		{"/foo", rspscaleHost, "/foo", false},
		{"//scale.ropsoft.cloud/foo", rspscaleHost, "//scale.ropsoft.cloud/foo", false},
		{"/a/foobar", rspscaleHost, "/a/foobar", false},
		...
		{"http://evil.com/foo", rspscaleHost, "", true},
		{"//evil.com", rspscaleHost, "", true},
		{"\\\\evil.com", rspscaleHost, "", true},
		{"javascript:alert(123)", rspscaleHost, "", true},
		{"file:///", rspscaleHost, "", true},
		{"file:////SERVER/directory/goats.txt", rspscaleHost, "", true},
		{"https://google.com", rspscaleHost, "", true},
		{"", rspscaleHost, "", false},
		{"\"\"", rspscaleHost, "", true},
		{"https://scale.ropsoft.cloud@goats.com:8443", rspscaleHost, "", true},
		{"https://scale.ropsoft.cloud:8443@goats.com:8443", rspscaleHost, "", true},
		{"HttP://scale.ropsoft.cloud", rspscaleHost, "http://scale.ropsoft.cloud", false},
		{"http://TaIlScAlE.CoM/spongebob", rspscaleHost, "http://TaIlScAlE.CoM/spongebob", false},
		{"ftp://scale.ropsoft.cloud", rspscaleHost, "", true},
		{"https:/evil.com", rspscaleHost, "", true},                     // regression test for rspscale/corp#892
		{"%2Fa%2F44869c061701", rspscaleHost, "/a/44869c061701", false}, // regression test for rspscale/corp#13288
		{"https%3A%2Fscale.ropsoft.cloud", rspscaleHost, "", true},            // escaped colon-single-slash malformed URL
		{"", nil, "", false},
	}
