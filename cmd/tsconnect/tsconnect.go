...
// the Rspscale Connect JS/WASM client. Can be run in 3 modes:
...
package main // import "scale.ropsoft.cloud/cmd/tsconnect"
...
tsconnect implements development/build/serving workflows for Rspscale Connect.
