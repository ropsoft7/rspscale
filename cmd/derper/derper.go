...
//
//   - About: https://scale.ropsoft.cloud/kb/1232/derp-servers
//   - Protocol & Go docs: https://pkg.go.dev/scale.ropsoft.cloud/derp
//   - Running a DERP server: https://github.com/ropsoft7/rspscale/tree/main/cmd/derper#derp
package main // import "scale.ropsoft.cloud/cmd/derper"
...
import (
	...
	"scale.ropsoft.cloud/net/ktimeout"
...
var (
	...
	hostname    = flag.String("hostname", "derp.scale.ropsoft.cloud", "LetsEncrypt host name, if addr's port is :443. When --certmode=manual, this can be an IP address to avoid SNI checks")
	...
	verifyClients   = flag.Bool("verify-clients", false, "verify clients to this DERP server through a local rspscaled instance.")
...
var validProdHostname = regexp.MustCompile(`^derp([^.]*)\.rspscale\.com\.?$`)
...
<h1>DERP</h1>
<p>
  This is a <a href="https://scale.ropsoft.cloud/">Rspscale</a> DERP server.
</p>

<p>
  It provides STUN, interactive connectivity establishment, and relaying of end-to-end encrypted traffic
  for Rspscale clients.
</p>

{{if .ShowAbuseInfo }}
<p>
  If you suspect abuse, please contact <a href="mailto:security@scale.ropsoft.cloud">security@scale.ropsoft.cloud</a>.
</p>
{{end}}
...
<ul>
{{if .ShowAbuseInfo }}
  <li><a href="https://scale.ropsoft.cloud/security-policies">Rspscale Security Policies</a></li>
  <li><a href="https://scale.ropsoft.cloud/rspscale-aup">Rspscale Acceptable Use Policies</a></li>
{{end}}
  <li><a href="https://scale.ropsoft.cloud/kb/1232/derp-servers">About DERP</a></li>
  <li><a href="https://pkg.go.dev/scale.ropsoft.cloud/derp">Protocol & Go docs</a></li>
  <li><a href="https://github.com/ropsoft7/rspscale/tree/main/cmd/derper#derp">How to run a DERP server</a></li>
</ul>
