...
package main // import "scale.ropsoft.cloud/cmd/hello"
...
func rspscaleIP(who *apitype.WhoIsResponse) string {
	if who == nil {
		return ""
	}
...
func root(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if devMode() {
			...
			http.Error(w, "Your Rspscale works, but we failed to look you up.", 500)
			return
		}
	} else {
		data = tmplData{
