...
var whoisCmd = &ffcli.Command{
	Name:       "whois",
	ShortUsage: "rspscale whois [--json] ip[:port]",
	ShortHelp:  "Show the machine and user associated with a Rspscale IP (v4 or v6)",
	LongHelp: strings.TrimSpace(`
	'rspscale whois' shows the machine and user associated with a Rspscale IP (v4 or v6).
	`),
	Exec: runWhoIs,
