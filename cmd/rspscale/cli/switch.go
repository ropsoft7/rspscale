...
var switchCmd = &ffcli.Command{
	Name:       "switch",
	ShortUsage: "rspscale switch <id>",
	ShortHelp:  "Switches to a different Rspscale account",
	LongHelp: `"rspscale switch" switches between logged in accounts. You can
...
func switchProfile(ctx context.Context, args []string) error {
	...
	if len(args) != 1 {
		outln("usage: rspscale switch NAME")
		os.Exit(1)
	}
