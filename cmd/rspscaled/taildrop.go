...
func configureTaildrop(logf logger.Logf, lb *ipnlocal.LocalBackend) {
	...
	case distro.Synology, distro.TrueNAS, distro.QNAP, distro.Unraid:
		...
		// See https://github.com/ropsoft7/rspscale/issues/2179#issuecomment-982821319
