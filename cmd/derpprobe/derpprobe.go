...
import (
	...
	"scale.ropsoft.cloud/prober"
	"scale.ropsoft.cloud/tsweb"
	"scale.ropsoft.cloud/version"
)

var (
	derpMapURL   = flag.String("derp-map", "https://login.scale.ropsoft.cloud/derpmap/default", "URL to DERP map (https:// or file://) or 'local' to use the local rspscaled's DERP map")
