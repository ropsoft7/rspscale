...
// connector for Rspscale. It is intended to be used to route traffic to a
...
// So in this case, the mailbox is support.scale.ropsoft.cloud. with the trailing dot
// to indicate that it is a fully qualified domain name.
var tsMBox = dnsmessage.MustNewName("support.scale.ropsoft.cloud.")
