...
// the normal rspscale cli is because it is not yet ready to go in the rspscale binary.
// It will be included in the rspscale cli after it has been added to rspscaled.
...
import (
	...
	"scale.ropsoft.cloud/net/speedtest"
)
