...
// checkmetrics validates that all metrics in the rspscale client-metrics
...
func main() {
	...
	// tsnet is used not used as a Rspscale client, but as a way to
	// boot up Rspscale, have all the metrics registered, and then
