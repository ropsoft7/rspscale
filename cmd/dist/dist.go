...
// The dist command builds Rspscale release packages for distribution.
package main
...
import (
	...
	"scale.ropsoft.cloud/release/dist/cli"
	"scale.ropsoft.cloud/release/dist/qnap"
	"scale.ropsoft.cloud/release/dist/synology"
	"scale.ropsoft.cloud/release/dist/unixpkgs"
)
...
func getTargets() ([]dist.Target, error) {
	...
	// packages that we distribute on pkgs.scale.ropsoft.cloud.
	//
