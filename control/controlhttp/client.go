...
// Package controlhttp implements the Rspscale 2021 control protocol
...
import (
	...
	"scale.ropsoft.cloud/control/controlhttp/controlhttpcommon"
...
// switch to the Rspscale control protocol, and returns an established control
// protocol connection.
//
...
func (d *Dialer) forceNoise443() bool {
	...
	if d.HealthTracker.LastNoiseDialWasRecent() {
		...
		// such as seen in https://github.com/ropsoft7/rspscale/issues/13597.
