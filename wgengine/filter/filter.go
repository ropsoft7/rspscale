...
import (
	...
	"scale.ropsoft.cloud/wgengine/filter/filtertype"
)
...
type Filter struct {
	...
	// respective address family. All packets coming in over rspscale must have
	...
	// applied to all packets arriving over rspscale
...
const (
	in  direction = iota // from Rspscale peer to local machine
	out                  // from local machine to Rspscale peer
)
