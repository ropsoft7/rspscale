...
const (
	...
	FromPeer Path = 1
	// SynthesizedToLocal indicates the packet was generated from within rspscaled,
	// and is being routed to the local machine's network stack.
	SynthesizedToLocal Path = 2
	// SynthesizedToPeer indicates the packet was generated from within rspscaled,
...
func (s *Sink) LogPacket(path Path, when time.Time, data []byte, meta packet.CaptureMeta) {
	...
	// Custom rspscale debugging data
