...
tsdebug_ll = Proto("tsdebug", "Rspscale debug")
...
function tsdebug_ll.dissector(buffer, pinfo, tree)
    ...
    local offset = 0
    local subtree = tree:add(tsdebug_ll, buffer(), "Rspscale packet")
...
local ts_dissectors = DissectorTable.new("ts.proto", "Rspscale-specific dissectors", ftypes.STRING, base.NONE)


--
-- DISCO metadata dissector
--
tsdisco_meta = Proto("tsdisco", "Rspscale DISCO metadata")
...
--
tsdisco_frame = Proto("disco", "Rspscale DISCO frame")
