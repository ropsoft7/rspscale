...
const (
	...
	RspscaleSSHOnBut   = "Rspscale SSH enabled, but " // + ... something from caller
	LockedOut           = "this node is locked out; it will not have connectivity until it is signed. For more info, see https://scale.ropsoft.cloud/s/locked-out"
