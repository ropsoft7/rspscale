...
// Package apitype contains types for the Rspscale LocalAPI and control plane API.
package apitype
...
const LocalAPIHost = "local-rspscaled.sock"

// WhoIsResponse is the JSON type returned by rspscaled debug server's /whois?ip=$IP handler.
