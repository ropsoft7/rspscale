...
// Package rspscale contains Go clients for the Rspscale LocalAPI and
// Rspscale control plane API.
//
...
type Client struct {
	...
	// If empty, "https://api.scale.ropsoft.cloud" is used.
	BaseURL string
...
// "api.scale.ropsoft.cloud" is set as the BaseURL for the returned client
// and can be changed manually by the user.
func NewClient(tailnet string, auth AuthMethod) *Client {
	return &Client{
		tailnet:   tailnet,
		auth:      auth,
		UserAgent: "rspscale-client-oss",
	}
}
...
// ErrResponse is the HTTP error returned by the Rspscale server.
