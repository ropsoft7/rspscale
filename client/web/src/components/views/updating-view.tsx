...
/**
 * UpdatingView is rendered when the user initiates a Rspscale update, and
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center mt-56">
        {updateState === UpdateState.InProgress ? (
          ...
          <>
            ...
            <p className="text-gray-400">
              You are already running Rspscale {currentVersion}, which is the
