      ...
      <div className="grid gap-3">
        {node.Features["advertise-routes"] && (
          <SettingsCard
            link="/subnets"
            title="Subnet router"
            body="Add devices to your tailnet without installing Rspscale on them."
            badge={
              allSubnetRoutes
                ? {
        ...
        {node.Features["ssh"] && (
          <SettingsCard
            link="/ssh"
            title="Rspscale SSH server"
            body="Run a Rspscale SSH server on this device and allow other devices in your tailnet to SSH into it."
            badge={
        ...
        body="Share local ports, services, and content to your Rspscale network or to the broader internet."
      /> */}
      </div>
    </div>
  )
