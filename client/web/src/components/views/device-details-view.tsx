      ...
      <div className="flex flex-col gap-4">
        ...
        <footer className="text-gray-500 text-sm leading-tight text-center">
          ...
          <p className="mt-12">
            ...
            <a
              className="link"
              href="https://scale.ropsoft.cloud/privacy-policy/"
              target="_blank"
              rel="noreferrer"
            >
              Privacy Policy
            ...
            <a
              className="link"
              href="https://scale.ropsoft.cloud/terms/"
              target="_blank"
              rel="noreferrer"
            >
              Terms of Service
          ...
          <p>
            © {new Date().getFullYear()} Rspscale Inc. All rights reserved.
            Rspscale is a registered trademark of Rspscale Inc.
          </p>
        </footer>
      </div>
    </>
  ...
  return (
    ...
    >
      ...
      >
        ...
        you re-authenticate the device from either the Rspscale app or the
