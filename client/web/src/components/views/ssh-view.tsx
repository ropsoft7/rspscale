...
export default function SSHView({
  ...
  return (
    <>
      <h1 className="mb-1">Rspscale SSH server</h1>
      <p className="description mb-10">
        Run a Rspscale SSH server on this device and allow other devices in
        your tailnet to SSH into it.{" "}
        <a
          href="https://scale.ropsoft.cloud/kb/1193/rspscale-ssh/"
