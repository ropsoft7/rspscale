...
export default function LoginView({ data }: { data: NodeData }) {
  ...
  return (
    <div className="mb-8 py-6 px-8 bg-white rounded-md shadow-2xl">
      <RspscaleIcon className="my-2 mb-8" />
      {data.Status === "Stopped" ? (
        <>
          <div className="mb-6">
            <h3 className="text-3xl font-semibold mb-3">Connect</h3>
            <p className="text-gray-700">
              Your device is disconnected from Rspscale.
            </p>
          </div>
          <Button
        ...
        <>
          <div className="mb-6">
            <p className="text-gray-700">
              ...
              logging in again, or{" "}
              <a
                href="https://scale.ropsoft.cloud/kb/1028/key-expiry"
                className="link"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <>
          <div className="mb-6">
            ...
            <p className="text-gray-700">
              Get started by logging in to your Rspscale network.
              Or,&nbsp;learn&nbsp;more at{" "}
              <a
                href="https://scale.ropsoft.cloud/"
                className="link"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <Collapsible trigger="Advanced options">
            ...
            <p className="text-sm text-gray-500">
              ...
              <a
                href="https://scale.ropsoft.cloud/kb/1085/auth-keys/"
                className="link"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <Input
              ...
              placeholder="https://login.scale.ropsoft.cloud/"
            />
          </Collapsible>
        </>
      )}
