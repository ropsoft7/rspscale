  ...
  const api = useCallback(
    (t: APIType) => {
      switch (t.action) {
        ...
        /**
         * "logout" handles logging the node out of rspscale, effectively
         * expiring its node key.
         */
        case "logout":
          // For logout, must increment metric before running api call,
          // as rspscaled will be unreachable after the call completes.
        ...
        /**
         * "update-prefs" handles setting the node's rspscale prefs.
         */
        case "update-prefs": {
