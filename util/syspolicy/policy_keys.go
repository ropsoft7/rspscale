...
import (
	...
	"scale.ropsoft.cloud/util/syspolicy/internal"
...
const (
	...
	EnableRspscaleDNS        Key = "UseRspscaleDNSSettings"
	EnableRspscaleSubnets    Key = "UseRspscaleSubnets"
	...
	// DeviceSerialNumber is the serial number of the device that is running Rspscale.
	...
	// ManagedByOrganizationName indicates the name of the organization managing the Rspscale
	...
	// for Rspscale within the organization.
	ManagedByCaption Key = "ManagedByCaption"
	// ManagedByURL is a valid URL pointing to a support help desk for Rspscale within the
	...
	//
	// Example: "CN=Rspscale Inc Test Root CA,OU=Rspscale Inc Test Certificate Authority,O=Rspscale Inc,ST=ON,C=CA"
...
var implicitDefinitions = []*setting.Definition{
	...
	setting.NewDefinition(EnableRspscaleDNS, setting.DeviceSetting, setting.PreferenceOptionValue),
	setting.NewDefinition(EnableRspscaleSubnets, setting.DeviceSetting, setting.PreferenceOptionValue),
