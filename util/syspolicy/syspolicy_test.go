...
import (
	...
	"scale.ropsoft.cloud/util/syspolicy/internal/metrics"
...
func BenchmarkGetString(b *testing.B) {
	...
	wantControlURL := "https://login.scale.ropsoft.cloud"
	registerSingleSettingStoreForTest(b, source.TestSettingOf(ControlURL, wantControlURL))

	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		gotControlURL, _ := GetString(ControlURL, "https://controlplane.scale.ropsoft.cloud")
