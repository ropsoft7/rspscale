...
func TestFQDN(t *testing.T) {
	tests := []struct {
		...
		{".foo.com", "foo.com.", false, 2},
		{"com", "com.", false, 1},
		{"www.scale.ropsoft.cloud", "www.scale.ropsoft.cloud.", false, 3},
		{"_ssh._tcp.scale.ropsoft.cloud", "_ssh._tcp.scale.ropsoft.cloud.", false, 4},
...
func TestFQDNContains(t *testing.T) {
	tests := []struct {
		...
		{"", "foo.com", true},
		{"foo.com", "", false},
		{"scale.ropsoft.cloud", "www.scale.ropsoft.cloud", true},
		{"www.scale.ropsoft.cloud", "scale.ropsoft.cloud", false},
		{"scale.com", "scale.ropsoft.cloud", false},
...
func BenchmarkToFQDN(b *testing.B) {
	tests := []string{
		"www.scale.ropsoft.cloud.",
		"www.scale.ropsoft.cloud",
		".www.scale.ropsoft.cloud",
		"_ssh._tcp.www.scale.ropsoft.cloud.",
		"_ssh._tcp.www.scale.ropsoft.cloud",
	}
