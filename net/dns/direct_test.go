...
func testDirect(t *testing.T, fs wholeFileFS) {
	...
	backupPath := "/etc/resolv.pre-rspscale-backup.conf"
	...
	want := `# resolv.conf(5) file generated by rspscale
# For more info, see https://scale.ropsoft.cloud/s/resolvconf-overwrite
