...
import (
	...
	"scale.ropsoft.cloud/net/dns/resolver"
		...
		},
		{
			...
			cfg: Config{
				Hosts: map[dnsname.FQDN][]netip.Addr{
					...
					"d.foo.beta.rspscale.net.": {netip.MustParseAddr("1.1.1.4")},
					"d.foo.ts.net.":             {netip.MustParseAddr("1.1.1.4")},
					"e.foo.beta.rspscale.net.": {netip.MustParseAddr("1.1.1.5")},
				...
				SearchDomains: []dnsname.FQDN{"foo.ts.net.", "foo.beta.rspscale.net."},
			},
			want: []*HostEntry{
				...
				{Addr: netip.MustParseAddr("1.1.1.4"), Hosts: []string{"d.foo.ts.net.", "d", "d.foo.beta.rspscale.net."}},
				{Addr: netip.MustParseAddr("1.1.1.5"), Hosts: []string{"e.foo.beta.rspscale.net.", "e"}},
			},
		},
		{
			...
			cfg: Config{
				Hosts: map[dnsname.FQDN][]netip.Addr{
					...
					"e.foo.beta.rspscale.net.":         {netip.MustParseAddr("1.1.1.5")},
					"e.ignored.foo.beta.rspscale.net.": {netip.MustParseAddr("1.1.1.6")},
				},
				SearchDomains: []dnsname.FQDN{"foo.ts.net.", "foo.beta.rspscale.net."},
			},
			want: []*HostEntry{
				{Addr: netip.MustParseAddr("1.1.1.5"), Hosts: []string{"e.foo.ts.net.", "e", "e.foo.beta.rspscale.net."}},
			},
		},
		{
		...
		},
		{
			...
			cfg: Config{
				Hosts: map[dnsname.FQDN][]netip.Addr{
					...
					"h1.foo.beta.rspscale.net.": {netip.MustParseAddr("1.1.1.2")},
					"h2.foo.ts.net.":             {netip.MustParseAddr("1.1.1.1")},
					"h2.foo.beta.rspscale.net.": {netip.MustParseAddr("1.1.1.1")},
					"example.com":                {netip.MustParseAddr("1.1.1.1")},
				},
				SearchDomains: []dnsname.FQDN{"foo.ts.net.", "foo.beta.rspscale.net."},
			},
			want: []*HostEntry{
				{Addr: netip.MustParseAddr("1.1.1.2"), Hosts: []string{"h1.foo.beta.rspscale.net."}},
				{Addr: netip.MustParseAddr("1.1.1.3"), Hosts: []string{"h1.foo.ts.net.", "h1"}},
				{Addr: netip.MustParseAddr("1.1.1.1"), Hosts: []string{"h2.foo.ts.net.", "h2", "h2.foo.beta.rspscale.net."}},
			},
		},
	}
...
func TestManager(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "search-only",
			in: Config{
				SearchDomains: fqdns("scale.ropsoft.cloud", "universe.tf"),
			},
			os: OSConfig{
				SearchDomains: fqdns("scale.ropsoft.cloud", "universe.tf"),
			},
		...
		{
			// Regression test for https://github.com/ropsoft7/rspscale/issues/1886
			name: "hosts-only",
			in: Config{
				Hosts: hosts(
					"dave.ts.com.", "1.2.3.4",
		...
		},
		{
			...
			os: OSConfig{
				Nameservers:   mustIPs("100.100.100.100"),
				SearchDomains: fqdns("scale.ropsoft.cloud", "universe.tf", "coffee.shop"),
			},
			rs: resolver.Config{
				Routes: upstreams(
					".", "8.8.8.8",
		...
		},
		{
			...
			// https://github.com/ropsoft7/rspscale/pull/10576
