...
// the daemon, which Rspscale also supports.
...
func (c *Config) Write(w io.Writer) error {
	...
	io.WriteString(buf, "# resolv.conf(5) file generated by rspscale\n")
	io.WriteString(buf, "# For more info, see https://scale.ropsoft.cloud/s/resolvconf-overwrite\n")
