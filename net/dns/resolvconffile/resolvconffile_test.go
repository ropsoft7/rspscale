...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{in: `search scale.ropsoft.cloud`,
			want: &Config{
				SearchDomains: []dnsname.FQDN{"scale.ropsoft.cloud."},
			},
		},
		{in: `search scale.ropsoft.cloud # comment`,
			want: &Config{
				SearchDomains: []dnsname.FQDN{"scale.ropsoft.cloud."},
			},
		},
		{in: `searchscale.ropsoft.cloud`, wantErr: true},
