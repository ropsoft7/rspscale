...
// Reproduces https://github.com/ropsoft7/rspscale/issues/2533
// Fixed by https://github.com/ropsoft7/scale.ropsoft.cloudmit/f414a9cc01f3264912513d07c0244ff4f3e4ba54
//
...
func TestForwarderTCPFallback(t *testing.T) {
	...
	const domain = "large-dns-response.scale.ropsoft.cloud."
...
func TestForwarderTCPFallbackError(t *testing.T) {
	...
	const domain = "error-response.scale.ropsoft.cloud."
