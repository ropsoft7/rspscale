...
type OSConfigurator interface {
	...
	// If cfg is the zero value, all Rspscale-related DNS
	...
	// resolver settings the OS would use without Rspscale
	// contributing any configuration.
	// GetBaseConfig must return the rspscale-free base config even
	// after SetDNS has been called to set a Rspscale configuration.
	...
	// Close removes Rspscale-related DNS configuration from the OS.
	Close() error
}
...
type OSConfig struct {
	...
	// whatever non-Rspscale search domains the OS has.
...
//
// Fixes https://github.com/ropsoft7/rspscale/issues/5669
