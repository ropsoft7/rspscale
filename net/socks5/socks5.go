...
//
// This is used for userspace networking in Rspscale. Specifically,
...
// details and not any integration with Rspscale internals itself.
//
// The glue between this package and Rspscale is in net/socks5/tssocks.
package socks5
