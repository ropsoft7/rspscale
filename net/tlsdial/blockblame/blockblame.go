...
// Package blockblame blames specific firewall manufacturers for blocking Rspscale,
...
// that is known to block Rspscale connections. It returns true and the Manufacturer of
...
// Manufacturer represents a firewall manufacturer that may be blocking Rspscale.
