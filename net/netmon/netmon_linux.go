...
func (c *nlConn) Receive() (message, error) {
	...
	case unix.RTM_NEWROUTE, unix.RTM_DELROUTE:
		...
		} else if tsaddr.IsRspscaleIP(dst.Addr()) {
			// Verbose only.
		...
		if msg.Header.Type == unix.RTM_DELROUTE {
			...
			// (Debugging https://github.com/ropsoft7/rspscale/issues/643)
			return unspecifiedMessage{}, nil
		}
	...
	case unix.RTM_DELRULE:
		// For https://github.com/ropsoft7/rspscale/issues/1591 where
	...
	case unix.RTM_NEWLINK, unix.RTM_DELLINK:
		...
		// See https://github.com/ropsoft7/rspscale/issues/6806
		return unspecifiedMessage{}, nil
	default:
...
func (m *newRouteMessage) ignore() bool {
	return m.Table == tsTable || tsaddr.IsRspscaleIP(m.Dst.Addr())
}
...
func (m *newAddrMessage) ignore() bool {
	return tsaddr.IsRspscaleIP(m.Addr)
}
