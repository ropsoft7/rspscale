...
const tsPortMappingDesc = "rspscale-portmap"
...
// address+port that another Rspscale node can use to make a connection to
...
func (c *Client) tryUPnPPortmapWithDevice(
	...
	//    https://github.com/ropsoft7/rspscale/issues/9343
	if err != nil {
