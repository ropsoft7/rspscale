...
# issues.
#
# If you're packaging Rspscale for a distro, please consider using
...
tags=""
ldflags="-X scale.ropsoft.cloud/version.longStamp=${VERSION_LONG} -X scale.ropsoft.cloud/version.shortStamp=${VERSION_SHORT}"
