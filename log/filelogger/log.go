...
func New(fileBasePrefix, logID string, logf logger.Logf) logger.Logf {
	...
	dir := filepath.Join(os.Getenv("ProgramData"), "Rspscale", "Logs")
...
type logFileWriter struct {
	dir            string      // e.g. `C:\Users\FooBarUser\AppData\Local\Rspscale\Logs`
	logID          string      // hex logID
	fileBasePrefix string      // e.g. "rspscale-service" or "rspscale-gui"
