...
// ServeNoContent generates the /generate_204 response used by Rspscale's
...
const (
	NoContentChallengeHeader = "X-Rspscale-Challenge"
	NoContentResponseHeader  = "X-Rspscale-Response"
)
