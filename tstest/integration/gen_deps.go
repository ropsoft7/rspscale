...
func generate(goos string) {
	...
	cmd := exec.Command("go", "list", "-json", "scale.ropsoft.cloud/cmd/rspscaled")
	...
	out.WriteString(`// Copyright (c) Rspscale Inc & AUTHORS
// SPDX-License-Identifier: BSD-3-Clause
...
`)
	...
	filename := fmt.Sprintf("rspscaled_deps_test_%s.go", goos)
