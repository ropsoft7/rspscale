...
// SetBlendReality sets whether to blend the real controlplane.scale.ropsoft.cloud and
...
// RspscaledEnv is а option that can be passed to Config.AddNode
// to set an environment variable for rspscaled.
type RspscaledEnv struct {
	Key, Value string
}
