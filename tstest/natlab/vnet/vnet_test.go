	...
	tests := []struct {
	...
	}{
		{
			...
			tests: []netTest{
				...
				{
					name: "syslog-v4",
					pkt:  mkSyslogPacket(clientIPv4(1), "<6>2024-08-30T10:36:06-07:00 natlabapp rspscaled[1]: 2024/08/30 10:36:06 some-message"),
					check: all(
						numPkts(0),
				...
				{
					name: "syslog-v6",
					pkt:  mkSyslogPacket(nodeWANIP6(1), "<6>2024-08-30T10:36:06-07:00 natlabapp rspscaled[1]: 2024/08/30 10:36:06 some-message"),
					check: all(
						numPkts(0),
						logSubstr("some-message"),
					),
...
// mkDNSReq makes a DNS request to "control.rspscale" using the source IPs as
