...
func (panicLogWriter) Write(b []byte) (int, error) {
	...
	panic(fmt.Sprintf("please use scale.ropsoft.cloud/logger.Logf instead of the log package (tried to log: %q)", b))
}
...
// through explicit scale.ropsoft.cloud/logger.Logf paths.
func PanicOnLog() {
