...
func TestHostinfoRspscaleSSHEnabled(t *testing.T) {
	tests := []struct {
		hi   *Hostinfo
		want bool
	}{
...
func TestDeps(t *testing.T) {
	deptest.DepChecker{
		BadDeps: map[string]string{
			...
			"scale.ropsoft.cloud/drive/driveimpl":  "https://github.com/ropsoft7/rspscale/pull/10631",
			"github.com/studio-b12/gowebdav": "https://github.com/ropsoft7/rspscale/pull/10631",
		},
	}.Check(t)
}
