...
type DERPMap struct {
	...
	// OmitDefaultRegions specifies to not use Rspscale's DERP servers, and only use those
...
type DERPRegion struct {
	...
	//
	// It corresponds to the legacy derpN.scale.ropsoft.cloud hostnames
	// used by older clients. (Older clients will continue to resolve
	// derpN.scale.ropsoft.cloud when contacting peers, rather than use
