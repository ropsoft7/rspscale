...
// Package kube contains types and utilities for the Rspscale Kubernetes Operator.
package kube
...
// RspscaledConfigFileName returns a rspscaled config file name in
// format expected by containerboot for the given CapVer.
func RspscaledConfigFileName(cap tailcfg.CapabilityVersion) string {
	return fmt.Sprintf("cap-%v.hujson", cap)
}

// CapVerFromFileName parses the capability version from a rspscaled
// config file name previously generated by RspscaledConfigFileNameForCap.
