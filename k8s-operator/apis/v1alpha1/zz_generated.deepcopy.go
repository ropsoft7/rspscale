...
func (in *Pod) DeepCopyInto(out *Pod) {
	*out = *in
	...
	if in.RspscaleContainer != nil {
		in, out := &in.RspscaleContainer, &out.RspscaleContainer
		*out = new(Container)
		(*in).DeepCopyInto(*out)
	}
	if in.RspscaleInitContainer != nil {
		in, out := &in.RspscaleInitContainer, &out.RspscaleInitContainer
		*out = new(Container)
		(*in).DeepCopyInto(*out)
	}
	if in.SecurityContext != nil {
...
func (in *ProxyClassSpec) DeepCopyInto(out *ProxyClassSpec) {
	*out = *in
	...
	if in.RspscaleConfig != nil {
		in, out := &in.RspscaleConfig, &out.RspscaleConfig
		*out = new(RspscaleConfig)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RspscaleConfig) DeepCopyInto(out *RspscaleConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RspscaleConfig.
func (in *RspscaleConfig) DeepCopy() *RspscaleConfig {
	if in == nil {
		return nil
	}
	out := new(RspscaleConfig)
