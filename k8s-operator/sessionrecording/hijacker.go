...
import (
	...
	"scale.ropsoft.cloud/k8s-operator/sessionrecording/spdy"
	"scale.ropsoft.cloud/k8s-operator/sessionrecording/tsrecorder"
	"scale.ropsoft.cloud/k8s-operator/sessionrecording/ws"
